...
from ModelGenerator import AutoEncoderGenerator
...
def train(model_name, type='snu'):
    ...
    test_type_1 = np.array(test_segments_set['preictal_ontime']+ test_segments_set['preictal_late'] + test_segments_set['preictal_early'] + test_segments_set['preictal_early'])
